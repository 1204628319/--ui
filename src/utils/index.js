 ...
 * @returns {string|*}
 */
export function buildOrgCode(selectOrgCode) {
  if (selectOrgCode === null || selectOrgCode === undefined || selectOrgCode.length === 0) {
    return ''
  }
  return selectOrgCode instanceof Array ? selectOrgCode[selectOrgCode.length - 1] : selectOrgCode
}
