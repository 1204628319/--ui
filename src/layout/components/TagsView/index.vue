  ...
  <div id="tags-view-container" class="tags-view-container">
    ...
    <scroll-pane ref="scrollPane" class="tags-view-wrapper">
      ...
      <div class="arrow-right">
        <i class="iconfont iconnext_icon" />
      </div>
      <div class="close" @click="closeAllTags(selectedTag)">
        <i class="iconfont iconshow_close_icon" />
      </div>
      <div class="refresh" @click="refreshSelectedTag(selectedTag)">
        <i class="iconfont iconshow_refresh_icon" />
      </div>
      <div class="left">
        <i class="iconfont iconfirst_icon" />
      </div>
    </scroll-pane>
